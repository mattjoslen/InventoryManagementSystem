...
public class ModifyPart2Controller {
    ...
    public void setPart(Part part) {
        ...
        if(part instanceof Outsourced) {
            ...
            partMachineIDTextField.setText(tempOut.getCompanyName());
        }
            ...
            partMachineIDTextField.setText(new Integer(tempIn.getMachineID()).toString());
        }
    }
